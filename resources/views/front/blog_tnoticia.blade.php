      ...
      <div class="row">
        <div class="col-md-12 col-lg-9">
          <div class="noticias-blog">
            ...
            <h2 class="title-pnoticias">Bascula Entregada en la Constructora 8A Ciudad de Caaguazu.</h2>
            <p class="title-sub">Bascula Entregada en la Constructora 8A en compañia del Ing. Recalde, residente de la Cantera.</p>
            ...
            <div class="info">
              ...
              <img class="img-blog-pnoticias" src="{{url('assets_front/images/banner2.jpg')}}" alt="">
