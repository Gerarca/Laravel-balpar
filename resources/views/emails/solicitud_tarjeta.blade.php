...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" style="margin: 0;padding: 0;min-width: 100%;background-color: #ffffff;">
  ...
  <div class="email_body" style="background-color: #ffffff;">
      ...
      <table class="jumbotron" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;">
        <tbody>
          <tr>
            <td class="jumbotron_cell jumbotron_image" align="center" valign="top" style="padding: 0;text-align: center;background-repeat: no-repeat;background-position: 50% 0;background-size: 100% auto;background-color: rgba(255, 255, 255, 0);color: #afcc09;font-size: 0 !important;">
                <!--[if (gte mso 9)|(IE)]>
                <table width="600" border="0" cellspacing="0" cellpadding="0" align="center" style="vertical-align: top;">
                  <tbody>
                    <tr>
                ...
                <div class="row" style="display: inline-block;width: 100%;vertical-align: top;text-align: center;max-width: 600px;margin: 0 auto;">
                  ...
                  <div class="col-3" style="display: inline-block;width: 100%;vertical-align: top;text-align: center;max-width: 600px;">
                    <table class="column" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;width: 100%;vertical-align: top;">
                      <tbody>
                        <tr>
                          <td class="column_cell font_default" align="center" valign="top" style="padding: 32px 16px;font-family: 'Helvetica Neue LT Std' !important;font-size: 16px;text-align: center;vertical-align: top;color: #afcc09;">
                            ...
                            <h1 style="font-family: 'Helvetica Neue LT Std' !important;margin-left: 0;margin-right: 0;margin-top: 16px;margin-bottom: 8px;padding: 0;font-size: 32px;line-height: 40px;font-weight: bold;text-transform: uppercase;letter-spacing: 4px;color: #afcc09;">Nueva solicitud de tarjeta</h1>
														<p style="font-family: 'Helvetica Neue LT Std' !important;font-size: 16px;line-height: 23px;margin-top: 16px;margin-bottom: 24px;"><em>Muchas gracias por completar la solicitud. Nuestro equipo se pondrá en contacto en los sucesivos días, tras el estudio de la misma. </em></p>
                ...
                <div class="row" style="display: inline-block;width: 100%;vertical-align: top;text-align: center;max-width: 600px;margin: 0 auto;">
                  ...
                  <div  style="display: inline-block;width: 100%;vertical-align: top;text-align: center;max-width: 300px;">
                    <table class="column" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;width: 100%;vertical-align: top;">
                      <tbody>
                        <tr>
                          <td class="column_cell font_default" align="center" valign="top" style="padding: 32px 16px;font-family: 'Helvetica Neue LT Std' !important;font-size: 16px;text-align: center;vertical-align: top;padding-top: 0;padding-bottom: 0;color: #afcc09;">
                            ...
                            <p style="font-family: 'Helvetica Neue LT Std' !important;font-size: 16px;line-height: 23px;margin-top: 16px;margin-bottom: 24px;">
															...
															Emai: {{ $email }}<br>
															Linea baja: {{ $telefono }}<br>
															Celular: {{ $celular }}<br>
															Dirección: {{ $direccion }}<br>
															Ciudad: {{ $ciudad }}<br>
															Lugar de trabajo/Empresa: {{ $trabajo }}<br>
															Salario: {{ $salario }}<br>
															Marca de tarjeta de crédito en otras entidades: {{ $tarjeta_marca }}<br>
															Línea en tarjeta de crédito en otras entidades: {{ $tarjeta_linea }}<br>
															Fecha de Nacimiento: {{ date('d/m/Y',strtotime($nacimiento)) }}<br>
														</p>
                          </td><!-- /.column_cell -->
                        </tr>
                      </tbody>
