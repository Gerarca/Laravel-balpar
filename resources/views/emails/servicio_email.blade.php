                      ...
                      <tbody>
                        <tr>
                          <td class="column_cell font_default" align="center" valign="top" style="padding: 32px 16px;font-family: 'Helvetica Neue LT Std' !important;font-size: 16px;text-align: center;vertical-align: top;padding-top: 0;padding-bottom: 0;color: {{ $color }};">
                            <h2 style="font-family: 'Helvetica Neue LT Std' !important;margin-left: 0;margin-right: 0;margin-top: 16px;margin-bottom: 8px;padding: 0;font-size: 16px;line-height: 24px;font-weight: bold;text-transform: uppercase;letter-spacing: 2px;color: #4e5558;">Datos del Solicitante</h2>
