                ...
                <div class="row" style="display: inline-block;width: 100%;vertical-align: top;text-align: center;max-width: 600px;margin: 0 auto;">
                  ...
                  <div class="col-3" style="display: inline-block;width: 100%;vertical-align: top;text-align: center;max-width: 600px;">
                    <table class="column" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;width: 100%;vertical-align: top;">
                      <tbody>
                        <tr>
                          <td class="column_cell font_default" align="center" valign="top" style="padding: 32px 16px;font-family: 'Helvetica Neue LT Std' !important;font-size: 16px;text-align: center;vertical-align: top;color: #30393d;">
                            ...
                            <h1 style="font-family: 'Helvetica Neue LT Std' !important;margin-left: 0;margin-right: 0;margin-top: 16px;margin-bottom: 8px;padding: 0;font-size: 32px;line-height: 40px;font-weight: bold;text-transform: uppercase;letter-spacing: 4px;color: #30393d;">Recuperar contrase&ntilde;a</h1>
                            <p style="font-family: 'Helvetica Neue LT Std' !important;font-size: 16px;line-height: 23px;margin-top: 16px;margin-bottom: 24px;"><em>Hola {{$nombre}}
                              <br>
                              Hemos recibido tu solicitud de recuperacion de acceso a nuestro Sitio Web de Pink Garden. Favor seguir el proceso dando click aqui:<br>

                              <div class="font_default" style="padding: 10px 32px;font-family: 'Helvetica Neue LT Std' !important;font-size: 19px;line-height: 28px;mso-line-height-rule: exactly;text-align: center;vertical-align: middle;-webkit-border-radius: 60px;border-radius: 60px;background-color: #afcc09;"><a href="{{$token}}" target="_blank" style="display: block;text-decoration: none;font-family: 'Helvetica Neue LT Std' !important;font-weight: bold;text-align: center;color: #ffffff;"><span style="text-decoration: none;text-align: center;display: block;color: #ffffff;">Recuperar</span></a></div>
                            </em></p>
