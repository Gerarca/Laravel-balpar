                      ...
                      <tbody>
                        <tr>
                          <td class="column_cell font_default" align="center" valign="top" style="padding: 32px 16px;font-family: 'Helvetica Neue LT Std' !important;font-size: 16px;text-align: center;vertical-align: top;color: #afcc09;">
                            ...
                            <h1 style="font-family: 'Helvetica Neue LT Std' !important;margin-left: 0;margin-right: 0;margin-top: 16px;margin-bottom: 8px;padding: 0;font-size: 32px;line-height: 40px;font-weight: bold;text-transform: uppercase;letter-spacing: 4px;color: #afcc09;">Felicidades! ya formas parte de nuestro newsletter!</h1>
