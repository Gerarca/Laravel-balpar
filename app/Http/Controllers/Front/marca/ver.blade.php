	...
	<nav aria-label="breadcrumb" class="breadcrumb-nav mb-0">
		<div class="container container-large">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="{{route('front.marcas')}}">Marcas</a></li>

				<li class="breadcrumb-item active" aria-current="page">{{ $marca->titulo }}</li>
			</ol>
		</div>
	</nav>

	<form class="" action="{{ route('front.marcas.ver',[$marca->id,str_slug($marca->titulo)])}}" id="form-filter" method="get">
		@csrf
		<div class="container container-large">
			<div class="row">
				<div class="col-lg-9">
            ...
            {{ $productos->appends(request()->input())->links() }}
				...
				<aside class="sidebar-shop col-lg-3 order-lg-first mobile-sidebar">
					<div class="sidebar-wrapper">
						...
						@if (sizeof($marcas_filtro)>=1)
						<div class="widget">
							<h3 class="widget-title">
								<a data-toggle="collapse" href="#widget-body-1" role="button" aria-expanded="true" aria-controls="widget-body-1">Otras marcas</a>
							</h3>

							<div class="collapse show" id="widget-body-1">
								<div class="widget-body">
									<ul>
											@foreach ($marcas_filtro as $pos => $marc)
												<li>
													<div class="custom-control custom-checkbox ">
														<a href="{{ route('front.marcas.ver',[$marc->id,str_slug($marc->titulo)])}}">{{$marc->titulo}}</a>
													</div>
