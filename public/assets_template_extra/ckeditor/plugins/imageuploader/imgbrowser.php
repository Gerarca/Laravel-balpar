...
<div id="header">
    ...
    <img onclick="pluginSettings();" src="img/cd-icon-settings.png" class="headerIconRight iconHover hideee">
    <?php endif; ?>
</div>
...
<div id="uploadImgDiv" class="lightbox popout">
    <div class="buttonBar">
        ...
        <button class="headerBtn greenBtn" name="submit" onclick="$('#uploadImgForm').submit();"><img src="img/cd-icon-upload.png" class="headerIcon"> Subir Archivo</button>
    </div><br><br><br>
    <form action="imgupload.php" method="post" enctype="multipart/form-data" id="uploadImgForm" onsubmit="return checkUpload();">

        <input type="file" name="upload" id="upload">
        <br><h3 class="settingsh3" style="font-size:12px;font-weight:lighter;">Este archivo sera subido al servidor para posteriormete poder utilizarlo<br><span style="font-weight:bolder;"></span> </h3>
        <br>
    </form>
</div>
