...
$foldershistory[] = $useruploadfolder;
    ...
    $useruploadfolder = "../../public";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "../../public";
    ...
    $useruploadfolder = "https://www.fuschia.com.py/public";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "https://www.fuschia.com.py/public";


    $useruploadfolder = "panel/assets/ckeditor-dev-master/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "panel/assets/ckeditor-dev-master/plugins/imageuploader/uploads";


    $useruploadfolder = "/var/www/html/public";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "/var/www/html/public";
    ...
    $useruploadfolder = "assets_template_extra/ckeditor-dev-master/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "assets_template_extra/ckeditor-dev-master/plugins/imageuploader/uploads";
